        ...
        <div id="product278009" class="panel panel-default product">
            <div class="panel-body">
                <div class="thumbnail">
                    ...
                    <div class="desc">
                        <div class="cell">
                            <p><span class="title">Details</span>Monitor diagonal 6.0" / Camera: 3.2Mp / RAM: 4 Gb /
                                Orange / 1100 mA/h / Weight 720 g / WiFi / Bluetooth / Dictophone / USB</p>
                        </div>
                    </div>
                </div>
        ...
        <div id="product278014" class="panel panel-default product">
            <div class="panel-body">
                <div class="thumbnail">
                    ...
                    <div class="desc">
                        <div class="cell">
                            <p><span class="title">Details</span>Monitor diagonal 9" / Matrix type: E lnk Pearl /
                                Resolution: 1600x1200 / Memory 6 GB / Weight 190 g</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="list-group">
                        <span class="list-group-item"> <small>Category:</small> <span
                                class="category">E-book</span></span>
        ...
        <div id="product278018" class="panel panel-default product">
            <div class="panel-body">
                <div class="thumbnail">
                    ...
                    <div class="desc">
                        <div class="cell">
                            <p><span class="title">Details</span>Monitor diagonal 4.4" / Camera: 3.2Mp / RAM: 1 Gb /
                                Blue / 1000 mA/h / Weight 320 g / 2 Sim cards / WiFi / USB / FM receiver /
                                Dictophone / 3G</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="list-group">
                    ...
                    <span class="list-group-item"> <small>Producer:</small> <span
                            class="producer">Huawei</span></span>
                </div>
            </div>
        </div>
        <!-- /PRODUCT DATA -->
        ...
        <div id="product278026" class="panel panel-default product">
            <div class="panel-body">
                <div class="thumbnail">
                    ...
                    <div class="desc">
                        <div class="cell">
                            <p><span class="title">Details</span>Monitor 9" / RAM 3 GB / HDD 370 GB / Black / Weight
                                60 g / Bluetooth / 3G / USB / GPS</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="list-group">
                        <span class="list-group-item"> <small>Category:</small> <span
                                class="category">Tablet</span></span>
                    <span class="list-group-item"> <small>Producer:</small> <span
                            class="producer">Apple</span></span>
                </div>
            </div>
        </div>
        <!-- /PRODUCT DATA -->
        ...
        <div id="product278031" class="panel panel-default product">
            <div class="panel-body">
                <div class="thumbnail">
                    ...
                    <div class="desc">
                        <div class="cell">
                            <p><span class="title">Details</span>Monitor 7" / RAM 4 GB / HDD 320 GB / Silver /
                                Weight 260 g / HDMI / GPS / Bluetooth</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel-body">
                <div class="thumbnail">
                    ...
                    <div class="desc">
                        <div class="cell">
                            <p><span class="title">Details</span>Monitor diagonal 4.4" / Camera: 3.2Mp / RAM: 1 Gb /
                                Black / 1700 mA/h / Weight 800 g / Bluetooth / 3G / FM receiver</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="list-group">
                    <span class="list-group-item"> <small>Category:</small> <span class="category">Smartphone</span></span>
                    <span class="list-group-item"> <small>Producer:</small> <span
                            class="producer">Samsung</span></span>
                </div>
            </div>
        </div>
        <!-- /PRODUCT DATA -->
